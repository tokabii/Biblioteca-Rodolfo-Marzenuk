...
/******************************************************
 * OBTENCIÓN DE LIBROS DESDE BASEROW (con paginación)
 ******************************************************/
...
function mostrarLibro(idLibro) {
  ...
  sinopsisEl.innerHTML = "";
  
  let haySinopsis = false;
  
  // Sinopsis 1 (sin subtítulo)
  if (libro["Sinopsis"] && String(libro["Sinopsis"]).trim() !== "") {
    const p1 = document.createElement("p");
    p1.textContent = libro["Sinopsis"];
    p1.style.marginBottom = "1.5rem";
    sinopsisEl.appendChild(p1);
    haySinopsis = true;
  }
  
  // Sinopsis 2
  if (libro["Sinopsis 2"] && String(libro["Sinopsis 2"]).trim() !== "") {
    const h4 = document.createElement("h4");
    h4.textContent = "Sinopsis 2";
    h4.style.color = "var(--primary)";
    h4.style.fontWeight = "600";
    h4.style.fontSize = "1.1rem";
    h4.style.marginTop = haySinopsis ? "1.5rem" : "0";
    h4.style.marginBottom = "0.8rem";
    
    const p2 = document.createElement("p");
    p2.textContent = libro["Sinopsis 2"];
    p2.style.marginBottom = "1.5rem";
    
    sinopsisEl.appendChild(h4);
    sinopsisEl.appendChild(p2);
    haySinopsis = true;
  }
  
  // Sinopsis 3
  if (libro["Sinopsis 3"] && String(libro["Sinopsis 3"]).trim() !== "") {
    const h4 = document.createElement("h4");
    h4.textContent = "Sinopsis 3";
    h4.style.color = "var(--primary)";
    h4.style.fontWeight = "600";
    h4.style.fontSize = "1.1rem";
    ...
    p3.textContent = libro["Sinopsis 3"];
    
    sinopsisEl.appendChild(h4);
    sinopsisEl.appendChild(p3);
    haySinopsis = true;
  }
  
  // Mostrar u ocultar el contenedor según si hay alguna sinopsis
  if (haySinopsis) {
